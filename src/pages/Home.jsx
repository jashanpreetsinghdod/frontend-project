  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] flex flex-col items-center justify-center p-4 font-sans text-slate-800 relative">
      ...
      <div className="w-full max-w-md space-y-6 pt-12 md:pt-0">
        ...
        <div className="bg-white p-6 rounded-3xl shadow-sm border-1 border-gray-100 flex items-center gap-4">
        ...
        {/* CARD 2: GAME ACTIONS */}
        <div className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border-1 border-gray-100">
